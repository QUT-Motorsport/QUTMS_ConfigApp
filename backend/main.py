...
# @app.sampleRoute('/sampleRoute')
# async def sampleRoute():
#     while True:
#         clientPackage = await sampleRoute.receive()
#         await sampleRoute.send(f"echo{clientPackage}")
...
async def registration():
     email = request.headers["email"]  # we can have e-mail as the user id primary key
